...
public class GridMamaliaAdapter extends RecyclerView.Adapter<GridMamaliaAdapter.GridViewHolder> {
    private Context context;
    LayoutInflater layoutInflater;
    public GridMamaliaAdapter(Context context) {
    ...
    public GridViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.item_grid_mamalia, parent, false);
    ...
    public void onBindViewHolder(@NonNull GridViewHolder holder, final int position) {
        holder.imgPhoto.setImageResource(dataimg[position]);
